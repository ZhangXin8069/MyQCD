\paragraph*{致谢}
我们深深感谢 Johannes Artz 与 Mario Prausa，他们帮助搭建了本计算所依托的
框架。我们还感谢 Tobias Neumann 富有成效的交流，并感谢他在
\citere{Artz:2019bpr} 发表之前提供其工具，使我们得以获得
$\mathring{Z}_\chi$。此外感谢 Mauro Papinutto 与 Alexandru Sturzu 指出
手稿早期版本中的排版错误与错误图形。本工作由德意志研究联合会（Deutsche
Forschungsgemeinschaft, DFG）项目
\href{http://gepris.dfg.de/gepris/projekt/386986591}{386986591} 资助。

\appendix

\section{费曼规则}\label{sec:frules}

本节给出常规 QCD 中 \eqn{eq:ops} 所定义算符的费曼规则。只显式列出对
\eqs{eq:p1} 与 \noeqn{eq:pj} 中投影符的构造相关的那些项。所有动量均理解为
外向。
\begin{align}
